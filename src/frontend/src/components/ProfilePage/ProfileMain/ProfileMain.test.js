...
describe('should render ProfileMain component is editable with country, city, positionAndCompany', () => {
  ...
  beforeEach(() => {
    ...
    component = setUp({profile, numberOfConnections, isEditable})
  })
  ...
  it('should work dispatch toggle modal upload avatar', () => {
    expect(mockDispatch).toHaveBeenCalledTimes(0)
    component.find('div[id=\'toggleModalUploadAvatar\']').simulate('click')
    expect(mockDispatch).toHaveBeenCalledTimes(1)
  })
  ...
  it('should render coma between city and country', () => {
    expect.stringContaining(', ')
  })
  it('should render SmallDot after city and country', () => {
    let wrapper = component.find('SmallDot')
    expect(wrapper.length).toBe(1)
  })
  it('should render BusinessTwoToneIcon before positionAndCompany', () => {
    let wrapper = component.find('span[id=\'positionAndCompany\']')
    expect(wrapper.length).toBe(1)
  })
  it('should render coma between city and country', () => {
    expect.stringContaining('55 connections')
  })
})

describe('should render ProfileMain component not editable without country, city, positionAndCompany', () => {
  let spyOnUseDispatch
  let mockDispatch
  ...
  it('should not work dispatch toggle modal upload profile bg', () => {
    expect(mockDispatch).toHaveBeenCalledTimes(0)
    component.find('div[id=\'toggleModalUploadProfileBg\']').simulate('click')
    expect(mockDispatch).toHaveBeenCalledTimes(0)
  })
  it('should not work dispatch toggle modal upload avatar', () => {
    expect(mockDispatch).toHaveBeenCalledTimes(0)
    component.find('div[id=\'toggleModalUploadAvatar\']').simulate('click')
    expect(mockDispatch).toHaveBeenCalledTimes(0)
  })
  it('should not work dispatch toggle modal edit intro', () => {
    expect(mockDispatch).toHaveBeenCalledTimes(0)
    component.find('div[id=\'toggleModalEditIntro\']').simulate('click')
    expect(mockDispatch).toHaveBeenCalledTimes(0)
  })
  it('should not render coma between city and country', () => {
    expect.not.stringContaining(', ')
  })
  it('should not render SmallDot without city and country', () => {
    let wrapper = component.find('SmallDot')
    expect(wrapper.length).toBe(0)
  })
  it('should not render BusinessTwoToneIcon and positionAndCompany', () => {
    let wrapper = component.find('span[id=\'positionAndCompany\']')
    expect(wrapper.length).toBe(0)
  })
  it('should not render number of connections', () => {
    let wrapper = component.find('div[id=\'numberOfConnections\']')
    expect(wrapper.length).toBe(0)
  })
})
