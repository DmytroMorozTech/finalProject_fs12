...
VALUES (date '2015-01-20', date '2015-01-20', 'Message text', 1, 2),
       ...
       (date '2015-01-20', date '2015-01-20', 'Message text3', 2, 3),
       (date '2015-01-20', date '2015-01-20', 'Message text4', 2, 3),
       (date '2015-01-20', date '2015-01-20', 'Message text5', 2, 4),
       (date '2015-01-20', date '2015-01-20', 'Message text6', 3, 5),
       (date '2015-01-20', date '2015-01-20', 'Message text7', 3, 6),
       (date '2016-10-01', date '2016-10-01', 'Message text8', 4, 7),
       (date '2017-02-11', date '2017-02-11', 'Message text9', 4, 8),
       (date '2017-02-21', date '2017-02-21', 'Message text10', 4, 7),
       (date '2017-05-09', date '2017-05-09', 'Message text11', 4, 7);